...
const SITUACIONES = [
  ...
  },
  {
    ...
    es:["Teatro o arte","Sentarse a mirar algo"],
    en:["Theatre or art","Sit down and watch"],
    pt:["Teatro ou arte","Sentar e ver algo"],
    dicho:{es:"de escenario", en:"on a stage", pt:"de palco"},
    ...
    pista:/\b(teatro|obras?|stand ?up|comedia|humor|monologos?|comediantes?|danza|ballet|circo|expo|exposicion(es)?|museos?|galerias?|arte|muestra|theatre|theater|exhibition|exhibit|art|peca|actuacion|dramaturgia|pintura|fotografia|escultura)\b/,
    opciones:[
      {id:"obra", es:"Una obra", en:"A play", pt:"Uma peça",
       pista:/\b(teatro|obras?|theatre|theater|peca|actuacion|dramaturgia|drama)\b/,
       efecto:{subcats:["obra","performance"], catsFuertes:["teatro"], senal:/\b(obra|dramaturg\w*|montaje|teatral)\b/i, pesos:{teatro:8, arte:-4}}},
      {id:"comedia", es:"Reírme un rato", en:"A good laugh", pt:"Dar risada",
       ...
       efecto:{subcats:["comedia"], senal:/\b(stand ?up|comedia|humor\w*|c[oó]mic\w*|mon[oó]log\w*|improvisaci[oó]n|impro\b|chistes?)\b/i, pesos:{teatro:8, arte:-6}}},
      {id:"danza", es:"Danza o circo", en:"Dance or circus", pt:"Dança ou circo",
       ...
       efecto:{subcats:["danza","circo"], senal:/\b(danza|ballet|circo|acrob\w*|malabar\w*|coreograf\w*)\b/i, pesos:{teatro:8, arte:-4}}},
      {id:"expo", es:"Una expo, a mi ritmo", en:"An exhibition, at my pace", pt:"Uma expo, no meu ritmo",
       ...
       efecto:{catsFuertes:["arte"], senal:/\b(expo\w*|muestra|galer[ií]a|museo|pintura|fotograf[ií]a|escultura|instalaci[oó]n)\b/i, pesos:{arte:8, teatro:-4}}},
    ],
    pesos:{teatro:11, arte:9}, evitar:["fiesta"], horaIdeal:[11,23],
    bonoGratis:2, soloPuntual:true,
  },
  {
    /* La Cabra habla de lo que se ve en una SALA, y es honesta sobre su
       alcance: acá adentro está lo que el catastro de panoramas conoce —el
       circuito de barrio, los cineclubes, los ciclos de los centros
       culturales—, que es justo lo que no aparece en ninguna otra app. La
       cartelera completa de las cadenas vive en cine.html, y lo dice en el
       saludo en vez de dejar que alguien se dé cuenta solo. */
    id:"cine", guia:"cabra",
    es:["Ir al cine","Una película en una sala"],
    en:["Go to the cinema","A film on a big screen"],
    pt:["Ir ao cinema","Um filme numa sala"],
    dicho:{es:"de cine", en:"at the cinema", pt:"de cinema"},
    saludo:{es:"Cabra. En Chile a las palomitas les dicen cabritas, así que del cine me hago cargo yo. Te aviso al tiro: acá te muestro los ciclos y el circuito de barrio, que es lo que no sale en ninguna otra parte. La cartelera de los malls, con horarios, está en la pestaña Cine.",
            en:"Goat. In Chile popcorn is called cabritas — little goats — so cinema is mine. Fair warning: here I show you seasons and the arthouse circuit, the stuff that is nowhere else. The multiplex listings, with showtimes, live in the Cinema tab.",
            pt:"Cabra. No Chile a pipoca se chama cabritas, então o cinema é comigo. Aviso já: aqui mostro os ciclos e o circuito de bairro, que é o que não aparece em nenhum outro lugar. A programação dos shoppings, com horários, está na aba Cinema."},
    pregunta:{es:"¿Qué quieres ver?", en:"What do you want to see?", pt:"O que você quer ver?"},
    pista:/\b(cine|peliculas?|pelis?|films?|movies?|documental(es)?|cinema|cortos?|cortometrajes?|cineclub|cartelera|funcion(es)?|estrenos?|filme)\b/,
    opciones:[
      {id:"estreno", es:"Cualquier película", en:"Any film", pt:"Qualquer filme",
       pista:/\b(pelicula|peli|estreno|film|movie|filme|lo que sea|cualquiera)\b/,
       efecto:{catsFuertes:["cine"], senal:/\b(pel[ií]cula|film\w*|estreno|funci[oó]n)\b/i, pesos:{cine:10}}},
      {id:"ciclo", es:"Un ciclo o una retrospectiva", en:"A season or retrospective", pt:"Um ciclo ou retrospectiva",
       pista:/\b(ciclo|retrospectiva|muestra|festival|fest|semana|maraton|homenaje)\b/,
       efecto:{senal:/\b(ciclo|retrospectiv\w*|muestra|festival|fest\b|maraton|homenaje|cineclub)\b/i, pesos:{cine:10}}},
      {id:"documental", es:"Un documental", en:"A documentary", pt:"Um documentário",
       pista:/\b(documental(es)?|documentary|documentario|no ficcion)\b/,
       efecto:{senal:/\b(documental\w*|no ficci[oó]n)\b/i, pesos:{cine:10}}},
      {id:"ninos", es:"Algo para ver con niños", en:"Something to watch with kids", pt:"Algo para ver com crianças",
       pista:/\b(nin[oa]s?|infantil(es)?|familiar(es)?|kids|children|criancas?|animacion|animad[ao]s?)\b/,
       efecto:{senal:/\b(infantil\w*|ni[ñn]\w*|familiar|animaci[oó]n|animad[ao])\b/i, pesos:{cine:10, familia:6}}},
    ],
    pesos:{cine:12}, horaIdeal:[15,23], bonoGratis:2, soloPuntual:true,
  },
  {
