...
const TEXTOS = {
  es:{
    ...
    filtrosRapidos:"Filtros rápidos", filtrosTipo:"Tipo de panorama",
  ...
  en:{
    ...
    filtrosRapidos:"Quick filters", filtrosTipo:"Type of event",
  ...
  pt:{
    ...
    filtrosRapidos:"Filtros rápidos", filtrosTipo:"Tipo de programa",
